...
class HostDaoImplTest {
    ...
    void testGetAllUserName() {
        // Act
        List<String> usernames = hostDao.getAllUserName();

        // Assert
        assertNotNull(usernames, "Usernames list should not be null");
        assertTrue(usernames.contains("updatedUser"), "Usernames list should contain the updated username");
    }
